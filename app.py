...
def model_predict(img_path, model):
   ...
   # x = preprocess_input(x)
    ...
    if preds==0:
        preds="We are sorry to inform that your lungs are affected by 'Covid'"
    elif preds==1:
        preds="YaY!!Your reports are'Normal'"
    else:
        preds="We are sorry to inform that your lungs affected by 'Pneumonia'"
